...
====================================================================================================================
<h2><u>require</u></h2>
<font size="3" color="#DDFFFF">JS中，在es6以前，它是不支持”类”（class），所以也就没有”模块”（module）了。require时代. Javascript社区做了很多努力，在现有的运行环境中，实现”模块”的效果。ES6标准发布后，module成为标准，标准使用是以export指令导出接口，以import引入模块，但是在我们一贯的node模块中，我们依然采用的是CommonJS规范，使用require引入模块，使用module.exports导出接口。</font>
链接： <url>http://www.cnblogs.com/libin-1/p/7127481.html </url>
====================================================================================================================
...
====================================================================================================================
函数内声明变量 如果与形参重名 则忽略，因为：优先级低于形参，无效

链接：
====================================================================================================================
====================================================================================================================
JS基本数据类型和引用数据类型的区别：
基本类型值指的是简单的数据段；引用类型值指由多个值构成的对象。当我们把变量赋值给一个变量时，解析器首先要做的就是确认这个值是基本类型值还是引用类型值
...
====================================================================================================================
基本类型、引用类型：
基本类型就是Undefined、Null、Boolean、Number、String，引用类型是object。基本包装类型和引用类型的区别就是生存期不同，在代码执行后就会销毁实例。
...
我们怎样检测请求的 URL 以及返回正确的页面？
除了简单的 GET 请求之外我们如何处理 POST 请求？
